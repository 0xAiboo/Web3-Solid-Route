...
contract ERC20 {
    ...
    function buyNft(
        ...
        uint256 price = market.queryPrice(contractAddress, tokenId);
        address owner = market.queryOwner(contractAddress, tokenId);
        require(balanceOf(msg.sender) >= price, "balances engouh");
        balances[owner] += price;
        balances[msg.sender] -= price;
        market.onERC721BuyReceived(contractAddress, msg.sender, tokenId, "");
    }
}
